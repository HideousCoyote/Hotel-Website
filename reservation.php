...
<div id = "main">
    ...
    if (isset($_POST['submit']))
    {
        ...
        // need room type id
        $idstatement = "SELECT room_type_id, total_room FROM room_type WHERE
        room_type_name = '$roomType'";
        if ($reslult = mysqli_query($mysqli, $idstatement))
        {
        ...
        // insert reservation
        if ($available > 0) {
            $insertStatement = "INSERT INTO reservation (room_type_id, begin_date,
            end_date, confirm_number) VALUES ('$roomTypeId', '$checkInDate',
            '$checkOutDate', '$confirmNumber')";
